...
/*
  ...
  Service names, descriptions, images and prices
  can be updated inside SERVICE_DATA below.

  The enquiry form is a front-end demo only.
*/
  ...
  form.addEventListener(
    ...
    event => {
      ...
      status.textContent =
        ...
        "demo only. It has not been sent to Lavish. Connect a secure " +
